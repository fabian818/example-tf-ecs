  ...
  components = {
    ...
    compute-data-visualization = {
      ...
      egress = [
        ...
        {
          source   = "storage-data-visualization-efs"
          from     = 2049
          to       = 2049
          protocol = "tcp"
        },
    ...
    storage-default-rds = {
      ...
      ingress = [
        ...
        {
          source   = "compute-data-visualization"
          from     = 5432
          to       = 5432
          protocol = "tcp"
        }
    ...
    storage-data-visualization-efs = {
      name = "Storage Data Visualization EFS"
      ingress = [
        {
          source   = "compute-bastion"
          from     = 2049
